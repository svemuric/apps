...
class SearchCommand(object):
    ...
    class ConfigurationSettings(object):
        ...
        def iteritems(self):
            ...
            return [name_value1 for name_value1 in map(
                    lambda setting: (setting.name, setting.__get__(self)), [setting for setting in definitions if setting.is_supported_by_protocol(version)]) if name_value1[1] is not None]
