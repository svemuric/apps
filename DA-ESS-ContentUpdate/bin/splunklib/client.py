...
class ReadOnlyCollection(Endpoint):
    ...
    def _entity_path(self, state):
        ...
        *state* should be the dictionary returned by
        ...
        raw_path = six.moves.urllib.parse.unquote(state.links.alternate)
...
class Index(Entity):
    ...
    def attach(self, host=None, source=None, sourcetype=None):
        ...
        path = UrlEncoded(PATH_RECEIVERS_STREAM + "?" + six.moves.urllib.parse.urlencode(args), skip_encode=True)
    ...
    def list(self, *kinds, **kwargs):
        ...
        if len(kinds) == 1:
            ...
            for entry in entries:
                ...
                # be URL encoded.
                path = six.moves.urllib.parse.unquote(state.links.alternate)
...
class Users(Collection):
    ...
    def create(self, username, password, roles, **params):
        ...
        **Example**::
        ...
        entity = self.item(
            self.service,
            six.moves.urllib.parse.unquote(state.links.alternate),
            state=state)
        return entity
